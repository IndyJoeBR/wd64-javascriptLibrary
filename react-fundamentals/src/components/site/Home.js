  ...
  return (
    <div className="main">
      <div className="mainDiv">
        ...
        <p>This app is intended to be a started/tutorial app for your upcoming
          project and a learning sandbod for you in months and years to come
          whould you continue to develop software with React.  In this
        ...
        <ul>
          <li>Being component based, you can move on to the next moduled.</li>
          ...
          <li>We have tried to collect the very best resources for this app, and
              we have cited those <Link to="/resource">here</Link>.</li>
